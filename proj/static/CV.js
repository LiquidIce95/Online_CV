...
// 
    let para_eth2 = ["static/Images/anhange/02/02_1.png", 0, 0, gw(600), gh(2400)];
...
// 
    let para_eth = ["static/Images/anhange/01/01-1.png", 0, 0, gw(600), gh(2400)];
...
// 
    let para_pass = ["static/Images/anhange/04/04-1.png", 0, 0, gw(600), gh(2400)];
...
// 
    let para_bm = ["static/Images/anhange/05/05-1.png", 0, 0, gw(600), gh(1200)];
...
// 
    let para_kv = ["static/Images/anhange/06/06-1.png", 0, 0, gw(600), gh(1200)];
...
function Experience([x,y]){
    ...
    let para_civi = ["static/Images/anhange/13/13-1.png", 0, 0, gw(600), gh(2400)];
...
// 
    let para_arm = ["static/Images/anhange/07/07-1.png", 0, 0, gw(600), gh(1200)];
    let para_arm2 = ["static/Images/anhange/11/11-1.png", 0, gh(1210), gw(600), gh(2400)];
    let para_arm3 = ["static/Images/anhange/12/12-1.png", 0, gh(3410), gw(600), gh(2400)];
...
// 
    let para_ass = ["static/Images/anhange/18/18-1.png", 0, 0, gw(600), gh(2400)];
...
// 
    let para_app = ["static/Images/anhange/16/16-1.png", 0, 0, gw(600), gh(2400)];
    let para_app2 = ["static/Images/anhange/17/17-1.png", 0, gh(1810), gw(600), gh(2400)];
...
function skills([x,y]){
    ...
    Lang_tableH.set_x(x);
    Lang_tableH.set_y(link.y+link.height+gh(30));
    ...
    OS_tableH.set_x(x);
    OS_tableH.set_y(Lang_tableH.y+gh(130)+topspace);
    ...
    DB_tableH.set_x(x);
    DB_tableH.set_y(OS_tableH.y+gh(150)+topspace);
    ...
    PL_tableH.set_x(x);
    PL_tableH.set_y(DB_tableH.y+gh(75)+topspace);
    ...
    O_tableH.set_x(x);
    O_tableH.set_y(PL_tableH.y+gh(250)+topspace);
